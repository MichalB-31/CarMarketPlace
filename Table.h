...
{
private:
	string table_name{}; //to trzeba zamienic na typ char prawdopodbnie bo ma problem potem odczytac, nie wiem czy spacji nie wstawia 
public:
	Table(string name);
	...
	int add_row(int id, string name, string surname, string login,string password, string email); //dodanie rzedu czyli calej informacji np. o uzytkowniku, o samochodzie
